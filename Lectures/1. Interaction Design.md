...
Finally, although not as process-drive, these two approaches can also work sometimes: 
...
This course is about *technical* ID. This means that we focus much more on the technological aspects of creating interactions. In particular we will discuss several technologies that you will likely need for the foreseeable future if you want to create any interactive application: 

- Javascript - We will go together in the first weeks through the important parts
- CSS - We will cover the lahyou
- React - We will cover from beginner to advanced topics

These are useful for almost any web development project. And web technologies are useful for almost any interactive application at the moment. 
